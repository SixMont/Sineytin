...
void JOYSTICK_move_x_DROITE(void){
	if (xJoueur>20){
		...
		ILI9341_DrawFilledRectangle(xJoueur-(10/2)-1, yJoueur-(10/2), xJoueur+(10/2)-1, yJoueur+(10/2), ILI9341_COLOR_RED);
		xJoueur-=1;
	}
}
...
void JOYSTICK2_move_x_DROITE(void){
	if (xJoueur2>20){
		...
		ILI9341_DrawFilledRectangle(xJoueur2-(10/2)-1, yJoueur2-(10/2), xJoueur2+(10/2)-1, yJoueur2+(10/2), ILI9341_COLOR_BLUE);
		xJoueur2-=1;
	}
}
